...
class MainActivity : SampleActivityBase() {
     ...
     * view that holds a [ScrollView] holding a [TextView] displaying our into message, with a 1dp
     * "darker_gray" [View] seperating it from a [FragmentContainerView] that holds a [LogFragment]
     * that displays any messages our app logs.
     *
     ...
     * descendant views).
     *
     * We initialize our [MenuHost] variable `menuHost` to `this` activity, then call
     * [MenuHost.addMenuProvider] with our [MenuProvider] property [menuProvider] as its `provider`
     * argument and `this` as its `owner` argument.
     *
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        menuHost.addMenuProvider(/* provider = */ menuProvider, /* owner = */ this)
    ...
    override fun initializeLogging() {
        ...
        @SuppressLint("ObsoleteSdkInt") // Kept in for reuse reference
